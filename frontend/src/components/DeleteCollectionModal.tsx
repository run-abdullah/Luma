...
import { DeleteCollection, GetCollections } from '../../wailsjs/go/main/App'
...
export default function DeleteCollectionModal(props: Props) {
  ...
  const handleDelete = async () => {
    ...
    try {
      await DeleteCollection(props.collectionPath)
  ...
  return (
    <Modal isOpen={props.isOpen} onClose={props.onClose} title="Delete Collection">
      <div class="space-y-4">
        <div class="flex items-start gap-3">
          ...
          <div>
            <p class="text-sm text-text-primary">
              Are you sure you want to delete <span class="font-semibold">"{props.collectionName}"</span>?
            </p>
            <p class="text-xs text-text-muted mt-1">
              This will permanently delete this collection and all its contents.
            </p>
          </div>
        </div>
